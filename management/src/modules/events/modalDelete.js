...
const ModalDelete = ({ toggleModal, selectedItem, refreshOverview }) => {
    ...
    const deleteManager = async () => { 
        ...
        await BackendClientRequest(
            path, { "email" : selectedItem.email }, headers, "POST" // TODO: change email to?
        ) 
                ...
                <div className="modal-dialog" role="document">
                    <div className="modal-content">
                        <div className="modal-header bg-moesland text-white">
                            <h5 className="modal-title">Evenement verwijderen </h5>
                        </div>
                        <form>
                            <div className="modal-body">
                                <p className="deleteModalText">Weet U zeker dat u dit evenement wilt verwijderen?</p>
                            </div>
