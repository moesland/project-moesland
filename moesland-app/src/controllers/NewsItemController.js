...
const content5 = [
  ...
  { id: 9, text: null, bold: false, image: require('../../assets/examples/pronkzitting2.png') },
  { id: 10, text: "De voorstellingen van deze 44e editie in dorpshuis De Phoenix zijn op: \nzaterdagmiddag 14 januari – ook kaartverkoop via KBO zaterdagavond \n14 januari vrijdagavond \n20 januari zaterdagavond \n21 januari", bold: false, image: null },
  { id: 11, text: "LET OP: Nieuw dit jaar is ook de fastlane voor de Moeskwekers. Er zijn daarmee dus géén gereserveerde plekken. Met de avondvoorstelling gaat de zaal voor de Moeskwekers een kwartier eerder open, zodat zij de gelegenheid hebben om plaats te nemen in de zaal. De fastlane is van 19:00uur tot 19:15uur, daarna gaat de zaal regulier open. Moeskwekers mogen natuurlijk ook na 19:15uur komen, maar sluiten dan gewoon in de rij aan. Het enthousiasme vanuit de Commissie en de artiesten is groot en ongetwijfeld ook vanuit alle Moeszakken en Moeszakkinnen, die weer een middag of avond ouderwets gezellig willen genieten!", bold: false, image: null },
  { id: 12, text: "Natuurlijk met onze Prins Djarek, Prinses Senne en Secondant Rick, die met hun hele gevolg in de bak op het podium zitten. Met een goei stukske muziek van onze eigen Hofkapel, genieten van de artiesten! Toi, toi!", bold: false, image: null },
  { id: 13, text: "Commissie Pronkzitting – Moesland", bold: false, image: null },
  { id: 14, text: null, bold: false, image: require('../../assets/examples/pronkzitting3.png') },
]
