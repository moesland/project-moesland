...
const items = [
  ...
  new Item(2, "30-01-2023",  'Sleuteloverdracht', 'Na enkele ongebruikelijke jaren, barst het carnavalsfeest op 17 februari weer op de vertrouwde manier los. Eén ding is wel veranderd in die tijd van afwezigheid en dat is dat we niet meer als Landerd en Uden door het leven gaan, maar dat we sinds 1 januari 2022 met zes dorpen de gemeente Maashorst vormen.', require('../../assets/examples/example_image_2.png')),
